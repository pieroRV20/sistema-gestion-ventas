        ...
        <table class="table">
            <thead>
              <tr>
                ...
                <th scope="col" style="background-color: #c57d56;">ID User</th>
            ...
            <tbody>
              ...
              <tr>
                  <th scope="row">4</th>
                  <td>Ruben</td>
                  <td>Abregu Calluchi</td>
                  <td>Ruben@hotmail.com</td>
                  <td>Dni</td>
                  <td>74373215</td>
                  <td>04</td>
                  <td>
              ...
              <tr>
                  <th scope="row">5</th>
                  <td>Rocio</td>
                  <td>Ramos Rivasplata</td>
                  <td>Rocio@hotmail.com</td>
                  <td>Dni</td>
                  <td>79787592</td>
                  <td>05</td>
                  <td>
